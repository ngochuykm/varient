...
export const ShareBox =  () => (
    <div className="share-box">
        <a href="/" target="_blank" className="mobile-menu-social mobile-menu-social-post icon-facebook icon-left">
            <FontAwesomeIcon icon={faFacebookF}></FontAwesomeIcon>
            <span>Facebook</span>
        </a>
        <a href="/" target="_blank" className="mobile-menu-social mobile-menu-social-post icon-twitter icon-left">
        ...
        <a href="/" target="_blank" className="mobile-menu-social icon-instagram icon-left">
            <FontAwesomeIcon icon={faInstagram}></FontAwesomeIcon>
        </a>
        <a href="/" target="_blank" className="mobile-menu-social icon-linkedin icon-left">
            <FontAwesomeIcon icon={faLinkedin}></FontAwesomeIcon>
        </a>
        <a href="/" target="_blank" className="mobile-menu-social icon-vk icon-left">
